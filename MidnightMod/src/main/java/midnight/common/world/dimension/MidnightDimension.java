...
public class MidnightDimension extends Dimension {
    ...
    public ChunkGenerator<?> createChunkGenerator() {
        return new MidnightChunkGenerator(world, new SingleBiomeProvider(new SingleBiomeProviderSettings(world.getWorldInfo()).setBiome(Biomes.PLAINS)), new GenerationSettings());
    }
