...
public class MnBlockLootTables extends BlockLootTables {
    ...
    protected void addTables() {
        ...
        registerLootTable(MnBlocks.SHADOWROOT_LEAVES, block -> droppingWithChancesAndSticks(block, MnBlocks.SHADOWROOT_SAPLING)); // TODO Stick should be dark stick later
        ...
        registerLootTable(MnBlocks.DARK_WILLOW_LEAVES, block -> droppingWithChancesAndSticks(block, MnBlocks.DARK_WILLOW_SAPLING)); // TODO Stick should be dark stick later
